  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 font-body tracking-wide",
  {
    variants: {
      variant: {
        ...
        hero: "bg-primary text-primary-foreground hover:bg-gold-light glow-gold uppercase tracking-widest font-semibold",
        heroOutline: "border-2 border-cream/40 text-cream bg-transparent hover:bg-cream/10 hover:border-cream uppercase tracking-widest font-semibold",
        gold: "bg-gradient-gold text-primary-foreground hover:opacity-90 glow-gold uppercase tracking-wider font-semibold",
        elegant: "bg-transparent border border-gold text-gold hover:bg-gold hover:text-primary-foreground uppercase tracking-wider",
      },
      size: {
